...
#define STRING_CONFIG_H_AUTHOR "(wmariz, sensorless)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Z6FB"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp 41.4421
    #define DEFAULT_Ki 4.0971
    #define DEFAULT_Kd 104.7968
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 321.3, 321.3, 6400, 563 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 10, 150 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 5000, 5000, 1500, 10000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, 0, -2.8 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT PROBING_MARGIN //X_CENTER  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT PROBING_MARGIN //Y_CENTER  // Y point for Z homing
#endif
...
// Preheat Constants
#define PREHEAT_1_LABEL       "PLA HT"
#define PREHEAT_1_TEMP_HOTEND 210
#define PREHEAT_1_TEMP_BED     70
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG XT"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { X_MIN_POS, Y_MAX_POS, Z_HOMING_HEIGHT }
...
#define LCD_FEEDBACK_FREQUENCY_HZ 400
